        ...
        <div class="big-box container">
            <div class="button-box row">
                ...
                <div class="col-xs-6 col-md-6">
                    <a href="index.php" class="btn-menu button row no-gutters">
                        <div class="col-3">
                            <svg
                        ...
                        <div class="col-9">
                            <p class="button-text">Make an appointment</p>
                        </div>
                    </a>
                </div>
                <div class="col-xs-6 col-md-6">
                    <a href="all_appointments.php" class="btn-menu button row no-gutters">
                        <div class="col-3">
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                width="20"
                        ...
                        <div class="col-9">
                            <p class="button-text">List of appointments</p>
                        </div>
                    </a>
                </div>
                <div class="col-xs-6 col-md-6">
                    <a href="information.php" class="btn-menu button row no-gutters">
                        <div class="col-3">
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                width="20"
                        ...
                        <div class="col-9">
                            <p class="button-text">Information</p>
                        </div>
                    </a>
                </div>
                <div class="col-xs-6 col-md-6">
                    <?php if (isset($_SESSION["user_id"])) :  ?>
                    <a href="includes/logout.inc.php" class="btn-menu button row no-gutters">
                        <div class="col-3">
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                width="20"
